...
function AboutMe() {
    ...
    return (
        <div className="text-center text-white component-glass-border">
            ...
            <p className='text-base text-gray-400 mb-10 mx-auto leading-relaxed whitespace-nowrap'>
            ...
            <div className='flex justify-center items-center space-x-16'>
                ...
                >
                    <FaBook className="text-4xl text-cyan-400 group-hover:text-cyan-300 transition-colors duration-300" />
                ...
                >
                    <FaLinkedin className="text-4xl text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />
                ...
                >
                    <GrMail className="text-4xl text-red-400 group-hover:text-red-300 transition-colors duration-300" />
                ...
                >
                    <FaGithub className="text-4xl text-gray-300 group-hover:text-white transition-colors duration-300" />
