...
function App() {
  ...
  return (
    <div className="h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative h-full w-full max-w-[1400px] mx-auto px-12 py-20 flex flex-col justify-center z-10">
        ...
        <div className="space-y-4">
          ...
          <div className={`grid grid-cols-2 gap-12 transition-all duration-500 ease-out delay-200 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            <Skills />
            <Frameworks />
          </div>
        </div>
